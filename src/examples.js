...
# Getters derive the product copy and starting values from shared Zero state.
state (
...
screen (
  ...
  box (
    ...
    box (
      ...
      radius "14",
      h "190px",
      label ( text { return 'LIMITED ' + Z('zero.state.edition').getter('') }, style "tag is-dark" ),
    ...
    box (
      ...
      box (
        ...
        border "0",
        pad "0",
        label ( text { return Z('zero.state.product').getter('') }, style "title", textcolor "#261d18", size "23", bold "true" ),
        label ( text "Warm light, sculptural balance.", style "subtitle", textcolor "#8b7567", size "11" )
      ),
      label ( text { return '$' + Z('zero.state.price').getter('') }, style "tag is-warning", size "12" )
    ),
    ...
    box (
      ...
      box (
        ...
        border "0",
        pad "0",
        label ( id "qty-label", text { return 'Quantity · ' + Z('zero.state.quantity').getter('') }, textcolor "#59483d", size "11", bold "true" ),
        slider (
          id "qty",
          value "1",
          min "1",
  ...
  label ( id "product-status", text { return Z('zero.state.delivery').getter('') }, textcolor "#8b7567", size "10", align "center", w "100%" )
)
`,
  },
